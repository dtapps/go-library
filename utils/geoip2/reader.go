...
func Open(file string, selectLanguage string) (*Reader, error) {
	...
	return &Reader{reader, dbType, selectLanguage}, err
}
...
func (r *Reader) CityWithLanguage(ipAddress netip.Addr) (*CityWithLanguage, error) {
	city, err := r.City(ipAddress)
	if err != nil {
		return nil, err
	}
	index := "en"
	switch city.Country.IsoCode {
	case "CN":
		index = "zh-CN"
	}
	...
	cityWithLanguage.Continent.Names = city.Continent.Names[index]
	cityWithLanguage.Continent.Code = city.Continent.Code
	cityWithLanguage.Continent.GeoNameID = city.Continent.GeoNameID

	for _, vSubdivision := range city.Subdivisions {
		cityWithLanguage.Subdivisions.Names = vSubdivision.Names[index]
		cityWithLanguage.Subdivisions.IsoCode = vSubdivision.IsoCode
		cityWithLanguage.Subdivisions.GeoNameID = vSubdivision.GeoNameID
	}

	cityWithLanguage.RepresentedCountry.Names = city.RepresentedCountry.Names[index]
	cityWithLanguage.RepresentedCountry.IsoCode = city.RepresentedCountry.IsoCode
	cityWithLanguage.RepresentedCountry.GeoNameID = city.RepresentedCountry.GeoNameID
	cityWithLanguage.RepresentedCountry.IsInEuropeanUnion = city.RepresentedCountry.IsInEuropeanUnion

	cityWithLanguage.Country.Names = city.Country.Names[index]
	cityWithLanguage.Country.IsoCode = city.Country.IsoCode
	cityWithLanguage.Country.GeoNameID = city.Country.GeoNameID
	cityWithLanguage.Country.IsInEuropeanUnion = city.Country.IsInEuropeanUnion

	cityWithLanguage.RegisteredCountry.Names = city.RegisteredCountry.Names[index]
	cityWithLanguage.RegisteredCountry.IsoCode = city.RegisteredCountry.IsoCode
	cityWithLanguage.RegisteredCountry.GeoNameID = city.RegisteredCountry.GeoNameID
	cityWithLanguage.RegisteredCountry.IsInEuropeanUnion = city.RegisteredCountry.IsInEuropeanUnion

	cityWithLanguage.Location = city.Location

	cityWithLanguage.Traits = city.Traits

	return cityWithLanguage, nil
}
