module go.dtapp.net/library/contrib/captureresponse

go 1.26.0

replace go.dtapp.net/library/framework => ../../framework

replace go.dtapp.net/library/utils/gojson => ../../utils/gojson

require go.dtapp.net/library/framework v1.0.33
...
require (
	...
	go.dtapp.net/library/utils/gojson v1.0.13 // indirect
