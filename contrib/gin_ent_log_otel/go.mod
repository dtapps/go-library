module go.dtapp.net/library/contrib/gin_ent_log_otel
...
require (
	go.dtapp.net/library/contrib/gin_ent_log v1.0.6
...
require (
	...
	go.dtapp.net/library/contrib/gin_requestid v1.0.6 // indirect
