...
import (
	...
	gostorage2 "go.dtapp.net/library/gostorage"
	"net/http"
)
...
// Update 上传
func (resp *WxaGetWxaCodeUnLimitResult) Update(storage *gostorage2.AliYun, filePath, fileName string) (gostorage2.FileInfo, error) {
