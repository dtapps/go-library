...
type OauthOrderDetailGet struct {
...
func (c *Client) OauthOrderDetailGet(ctx context.Context, notMustParams ...*gorequest.Params) (response OauthOrderDetailGet, err error) {
