...
func (c *Client) UserInfo(ctx context.Context, notMustParams ...*gorequest.Params) (response UserInfo, err error) {
	// 参数
	params := gorequest.NewParamsWith(notMustParams...)
	// 请求
	err = c.request(ctx, c.WithUrlAuthorizerAccessToken("cgi-bin/user/info"), params, http.MethodPost, &response)
	return
}
