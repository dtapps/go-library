...
func (c *Client) CgiBinWxOpenQrCodeJumpPublish(ctx context.Context, authorizerAccessToken, prefix string, notMustParams ...*gorequest.Params) (response APIResponse, err error) {
	...
	// 请求
	err = c.request(ctx, "cgi-bin/wxopen/qrcodejumppublish?access_token="+authorizerAccessToken, params, http.MethodPost, &response)
	return
}
