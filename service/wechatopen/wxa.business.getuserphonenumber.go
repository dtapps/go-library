...
func (c *Client) WxaBusinessGetUserPhoneNumber(ctx context.Context, code string, notMustParams ...*gorequest.Params) (response WxaBusinessGetUserPhoneNumberResponse, err error) {
	...
	// 请求
	err = c.request(ctx, "wxa/business/getuserphonenumber?access_token="+c.GetAuthorizerAccessToken(), params, http.MethodPost, &response)
	return
}
