...
func (c *Client) CgiBinComponentApiCreatePreAuthCoden(ctx context.Context, componentAccessToken string, notMustParams ...*gorequest.Params) (response CgiBinComponentApiCreatePreAuthCodenResponse, err error) {
	...
	// 请求
	err = c.request(ctx, fmt.Sprintf("cgi-bin/component/api_create_preauthcode?component_access_token=%s", componentAccessToken), params, http.MethodPost, &response)
	return
}
