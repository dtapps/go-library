...
func (c *Client) WxaAddToTemplate(ctx context.Context, draftId string, templateType int, notMustParams ...*gorequest.Params) (response APIResponse, err error) {
	...
	// 请求
	err = c.request(ctx, "wxa/addtotemplate?access_token="+c.GetComponentAccessToken(), params, http.MethodPost, &response)
	return
}
