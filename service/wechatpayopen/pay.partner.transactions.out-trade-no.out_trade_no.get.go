...
func (c *Client) PayPartnerTransactionsOutTradeNoOutTradeNoGet(ctx context.Context, outTradeNo string, notMustParams ...*gorequest.Params) (response PayPartnerTransactionsOutTradeNoOutTradeNoGetResponse, apiError ApiError, err error) {
