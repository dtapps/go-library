...
func (c *Client) EcommerceFundEndDayBalance(ctx context.Context, date string, notMustParams ...*gorequest.Params) (response EcommerceFundEndDayBalanceResponse, err error) {
