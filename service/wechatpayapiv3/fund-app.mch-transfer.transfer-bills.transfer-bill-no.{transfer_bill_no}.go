...
type FundAppMchTransferTransferBillsBillsTransferBillNoResponse struct {
...
// FundAppMchTransferTransferBillsTransferBillNo 微信单号查询转账单
// https://pay.weixin.qq.com/doc/v3/merchant/4012716457
func (c *Client) FundAppMchTransferTransferBillsTransferBillNo(ctx context.Context, transfer_bill_no string, notMustParams ...*gorequest.Params) (response FundAppMchTransferTransferBillsBillsTransferBillNoResponse, apiError ApiError, err error) {

	// 参数
	params := gorequest.NewParamsWith(notMustParams...)

	// 请求
	err = c.DoRequest(ctx, "/v3/fund-app/mch-transfer/transfer-bills/transfer-bill-no/"+transfer_bill_no, params, http.MethodGet, &response, &apiError)
	return
}
